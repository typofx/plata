...
Namespace WinFormsApp1
    Partial Public Class Scriptsp0
        ...
        Private urls As String() = {"https://typofx.ie/plataforma/panel/token-historical-data/index.php?passwrd=platabotacess20112024@"}
        ...
        Public Sub New()
            ...
            AddHandler Me.FormClosing, AddressOf Scriptsp0_FormClosing
            AddHandler Shown, AddressOf Scriptsp0_Shown
        End Sub

        Private Sub Scriptsp0_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Private Async Sub EnviarSinalOnlineAsync()
            Try
                ...
                Dim app As String = "Database Scripts P" & ScriptNumber
        ...
        Private Async Sub Scriptsp0_FormClosing(sender As Object, e As FormClosingEventArgs)
        ...
        Private Sub Scriptsp0_Shown(sender As Object, e As EventArgs)
