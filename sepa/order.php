...
<body>
    ...
    <html lang="">
<link rel="stylesheet" href="https://www.plata.ie/sepa/pix3-style.css">
...
<h3>Buy Plata with SEPA</h3>
<div>
    
    <form id="form1" method="post" action="sepa.php">
        <?php
        ...
        <div>
            <label for="valor" class="div-label">Amount Payable (EUR)</label><br>
        </div>
        <div>
        ...
        <div>
            <label for="PLTwanted" class="div-label">Predicted Silver Tokens (PLT)</label>
        </div>
        <div>
        ...
        <div>
            <label for="web3wallet" class="div-label">EVM Wallet / Polygon(MATIC)</label>
        </div>
        <div>
        ...
        <div>
            <label for="aib" class="div-label">Allied Irish Banks (AIB) </label>
        </div>
        <div>
            <input type="text" id="aib" name="aib" required>
        </div>

        <hr width="95%" />
        <button type="submit" name="verify_code" class="buttonBuyNow">Buy <i class="fas fa-qrcode"></i></button>
        <hr width="95%" />
        <a href="https://www.plata.ie/sepa/email.php?order_cancel=true">Cancel</a>
        <hr width="95%" />
    </form>
    ...
    <?php
    date_default_timezone_set('UTC');
    echo "<br>Valid Until : ". $Expdate;
    ?>
    <br>
    <br>
    </div></div>
    <br>
    <a id="dappVersion">PlataSEPA dApp Version 1.1.0 (Beta)</a>
    <script>
        document.getElementById("valorpix").value = "10.00";
        let _PLTBRL = <?php echo number_format($PLTEUR, 8, '.', ''); ?>;
