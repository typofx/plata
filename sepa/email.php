    ...
    if (isset($_POST['send_email']) || isset($_POST['resend_code'])) {
        if (isset($_POST['email']) || isset($_SESSION['email'])) {
            ...
            if (!isset($_SESSION['code_sent']) || checkResendLimit()) {
                ...
                echo '<script type="text/javascript"> window.location.href = "https://www.plata.ie/sepa/index";</script>';
            }
        } else {
...
if (!isset($_SESSION['code_sent'])) {
    include $_SERVER['DOCUMENT_ROOT'] . '/sepa/email_sent.php';
}

if (isset($_SESSION['email'])) {
    include $_SERVER['DOCUMENT_ROOT'] . '/sepa/confirm_email.php';
}
?>
<br>
