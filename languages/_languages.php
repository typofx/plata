...
//$language = substr($_SERVER['HTTP_ACCEPT_LANGUAGE'], 0, 2);
        ...
        $txtPlataToken = "Locais Listados do Plata";  
        ...
        $txtInitialSplit = "Divisão Inicial (2022)";
            ...
            $txtDecentralized = "Gestão Descentralizada ( 5% )";
            $txtExpenses = "Mentores do Projeto ( 5% ) ";
            $txtMarketing = "Promoções e Propaganda ( 20% )";
        ...
        $txtNFTmarketplace = "Negociações de NFT";
            ...
            $txtRainfallVictims = "Vitimas das Chuvas no Brasil ( 50% )";
