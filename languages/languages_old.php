<body>
    ...
    if ($CurrentPageURL == "pt") {
        ...
        $txtChannelVerification = 'Verificar Canal';
        ...
        $txtRights = "© " . date("Y") ." Typo FX | Todos os direitos reservados";
        ...
        $txtChannelVerification = 'Comprobar Canal';
        ...
        $txtRights = "© " . date("Y") ." Typo FX |  Reservados todos los derechos";
        ...
        $txtSandMenuMeetTheTeam = 'Meet The Team';
        $txtSandMenuSocialMedia = 'Social Media';
        $txtChannelVerification = 'Channel Verification';
        $txtSandMenuReportBug = 'Report Bug';
        $txtSandMenuEmail = 'Email';
        ...
        $txtRights = "© " . date("Y") ." Typo FX | All rights reserved";
