...
<body>
  ...
  include '/home2/granna80/public_html/en/mobile/price.php';
  echo '</div>';
  ?>
  ...
  $selectedMarketcap1 = $PLTmarketcapBRL;
  $selectedMarketcap2 = $PLTmarketcapEUR;
  ...
  $selectedPair = $PLTUSD;
  $selectedPair1 = $PLTBRL;
  $selectedPair2 = $PLTEUR;
      ...
      <div class="col-md-6">
        <form style="display:none;">
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              <input type="text" class="form-control" id="name" name="name" value="Plata" readonly>
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              <input type="text" class="form-control" id="symbol" name="symbol" value="PLT" readonly>
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              <input type="text" class="form-control" id="price" name="price" value="<?= $selectedPair ?>" readonly>
  ...
  <body>
    ...
    <?php
    if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["symbol"]) && isset($_POST["name"]) && isset($_POST["price"])) {
      $symbol = $_POST["symbol"];
      $name = $_POST["name"];
      $price = $_POST["price"];
      $priceBRL = $selectedPair1;
      $priceEUR = $selectedPair2;
      $MarketcapUSD = $selectedMarketcap;
      $MarketcapBRL = $selectedMarketcap1;
      $MarketcapEUR = $selectedMarketcap2;

      date_default_timezone_set('UTC');
      $datetime = new DateTime();
      $hour_utc = $datetime->format('d-m-Y H:i:s');
      ...
      $category = "token";
      $webURL = "https://www.plata.ie";
      $maximumSupply = (22299000992);
      $totalSupply = (22299000992);
      $tokenLogo = "https://plata.ie/images/platatoken400px.png";
      $chainID = (137);
      $Contract = "0xC298812164BD558268f51cc6E3B8b5daAf0b6341";
      $decimals = (4);
      $explorer = "https://polygonscan.com/address/0xc298812164bd558268f51cc6e3b8b5daaf0b6341#code";
      ...
      $jsonContent = '{
        ...
        "Statistics": {
          "fullyDilutedMarketCapUSD": ' . (int)str_replace([',', '.'], '', $MarketcapUSD) . ',
          "fullyDilutedMarketCapBRL": ' . (int)str_replace([',', '.'], '', $MarketcapBRL) . ',
          "fullyDilutedMarketCapEUR": ' . (int)str_replace([',', '.'], '', $MarketcapEUR) . ',
            "circulatingSupply": ' . $PLTcirculatingSupply . ',
      ...
      $filePath = __DIR__ . "/crypto_data.json";

      if (file_put_contents($filePath, $jsonContent) !== false) {
        echo "Arquivo JSON criado com sucesso!";
        // Redirect to the page of the JSON
    ...
    <script>
      function createJSON() {
        ...
        formData.append("priceBRL", "<?php echo $selectedPair1; ?>");
        formData.append("priceEUR", "<?php echo $selectedPair2; ?>");
      ...
      window.addEventListener("load", createJSON);
    </script>
    <h1>JSON CONTROL</h1>
    <li><a href="crypto_data.json">GET</a></li>
...
<script>
  async function fetchData() {
    try {
      ...
      console.error('Something went wrong with retrieving or parsing the data!', error);
    }
  }
