        ...
        <table class="wallets-table">
            <td>
                ...
                <tr>
                    ...
                    <td class="wlttd"><a href="https://www.coinbase.com/wallet"target="_blank"><img style="75px" src="https://www.plata.ie/images/bitget.png"><br><a>Bitget</a></td>
                </tr>
                </table>
                <h2 class="u-align-center u-custom-font u-font-montserrat u-text u-text-grey-90 u-text-3"><?php echo $txtExploreBlockchain?><br></h2>
            </td>
