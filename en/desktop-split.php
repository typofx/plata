    <link rel="stylesheet" href="desktop-style-split.css">
...
<div class="background-ground">
    ...
    <table class="tb-token">
        ...
        <tr>
            ...
            <td class="tb-subtitle" colspan="8"><center><h2>Plata Tokenomics</h2></center></td>
        ...
        <tr class="line-column-border">
            ...
            <td colspan="4" class="td-token-column td-token-split">
                    ...
                    <table class="split-table"> 
                        ...
                        <tr>
                            ...
                            <td><h3 class="tb-subtitle" id="txtSplit">Token Allocation (2023)</h3></td>
                    ...
                    <table class="split-table">
                        ...
                        <tr>
                            ...
                            <td class="td-suply"><a class="gray-button">Circulating Supply: 11,299,000,992 PLT</a></td>
            ...
            <td colspan="4" class="td-tb-info td-token-column line-column-border">
                ...
                <table id="tbInitialSplit" class="tb-info border-text-align invisibled">
                ...
                <table id="tbAllocation2023" class="tb-info border-text-align">
                 ...
                 <table id="tbNFTsell" class="tb-info border-text-align invisibled">
    ...
    <table class="split-table-buttons">
        ...
        <tr>
            ...
            <td class="tb-typofx"><a>Typo FX</a></td>
