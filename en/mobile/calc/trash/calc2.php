...
?>
<center><h3>Token Calculator</h3></center>
...
<form method="post" action="">
    ...
    <div class="row row-cols-lg-auto g-3 align-items-center">
        <label for="valor" class="form-label">MATIC</label>
    ...
    <div class="row row-cols-lg-auto g-3 align-items-center">
        <label for="valor" class="form-label">Ethereum (ETH)</label>
        <input type="text" id="valor" name="valor" placeholder="Informe o valor a cobrar" size="15" maxlength="13" min="5" value="<?= $valor_pix; ?>" onclick="this.select();" onkeypress="mascara(this,reais)" required>
    </div>

    <div class="row row-cols-lg-auto g-3 align-items-center">
        <label for="valor" class="form-label">Bitcoin (BTC)</label>
        <input type="text" id="valor" name="valor" placeholder="Informe o valor a cobrar" size="15" maxlength="13" min="5" value="<?= $valor_pix; ?>" onclick="this.select();" onkeypress="mascara(this,reais)" required>
    </div>
   
    <div class="row row-cols-lg-auto g-3 align-items-center">
        <label for="valor" class="form-label">US Dollar (USD)</label>
        <input type="text" id="valor" name="valor" placeholder="Informe o valor a cobrar" size="15" maxlength="13" min="5" value="<?= $valor_pix; ?>" onclick="this.select();" onkeypress="mascara(this,reais)" required>
    </div>

    <div class="row row-cols-lg-auto g-3 align-items-center">
      <label for="valor" class="form-label">Euro (EUR)</label>
      <input type="text" id="valor" name="valor" placeholder="Informe o valor a cobrar" size="15" maxlength="13" min="5" value="<?= $valor_pix; ?>" onclick="this.select();" onkeypress="mascara(this,reais)" required>
   </div>
   <div class="row row-cols-lg-auto g-3 align-items-center">
      <label for="valor" class="form-label">Brazilian Real (BRL)</label>
      <input type="text" id="valor" name="valor" placeholder="Informe o valor a cobrar" size="15" maxlength="13" min="5" value="<?= $valor_pix; ?>" onclick="this.select();" onkeypress="mascara(this,reais)" required>
   </div>
