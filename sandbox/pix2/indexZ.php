...
<body>
    ...
    <form method="POST">
        ...
        <input type="number" id="verification_code" name="verification_code" max="999999" value="<?php echo $userCode  ?>">
        <br>
        <button type="submit" class="buttonBuyNow" name="send_email">Send Email</button>
        <button type="submit" class="buttonBuyNow" name="resend_code">Resend</button>
        <button type="submit" class="buttonBuyNow" name="confirm_code">Confirm</button>
    </form>
    </div>
    ...
    <form method="POST">
        ...
        <button type="submit" class="buttonBuyNow" name="confirm_code">Confirm Code</button>
    </form>
</body>
...
<form method="post" action="0xc298812164bd558268f51cc6e3b8b5daaf0b6341.php" target="_blank">
                    ...
                    <div>
                        <div class="div-label"><label for="wallet">   Carteira Polygon Ecosystem (EVM)</label></div>
                        <div>
                        ...
                        <div>
                            ...
                            <button type="submit" id="submitButton" class="buttonBuyNow">Gerar QR Code <i class="fas fa-qrcode"></i></button>
                            <hr width="95%" class="hrline" />
                </form>
