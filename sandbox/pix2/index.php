        ...
        <div id="box" class="box">
            ...
            <div id="forml">
                <form method="post" action="" target="_blank">
                    ...
                    <form method="POST" action="verify_email.php" id="verification_form">
                        <input type="hidden" id="action" name="action">
                        <input type="hidden" id="emailUserHidden" name="emailUser" value="<?= htmlspecialchars($_POST["emailUser"] ?? ''); ?>">

                        <div class="div-label"><label for="verification_code">Verification Code</label></div>
                        <input type="number" id="verification_code" name="verification_code" max="999999" size="60" maxlength="90" value="<?= htmlspecialchars($userCode ?? ''); ?>"><br>

                        <a href="#" onclick="submitForm('send_email')" name="send_email">[Send Email]</a>
                        <a href="#" onclick="submitForm('resend_code')">[Resend Code]</a>
                        <a href="#" onclick="submitForm('confirm_code')">[Confirm Code]</a>
                    </form>
                    ...
                    <div>
                        <div class="div-label"><label for="email">   Carteira Polygon Ecosystem (EVM)</label></div>
                        <div>
