...
<table id="tableBarMenu">
        <td class="td-plata-font"><a href="https://www.plata.ie/"><img id="plata-font" class="plata-font" src="https://www.plata.ie/images/PlataFont1.svg"></a></td>
        <td class="td-menu-icons">
        <table class="tableIconMenu">
                <td><a href="https://www.plata.ie/en/mobile/calc/"><img class="img-menu" src="https://www.plata.ie/images/header-icon-calc.svg"></a></td>
                <td><a href="https://www.plata.ie/en/select/"><img class="img-menu" src="https://www.plata.ie/images/header-icon-trolley.svg"></a></td>
                <td><a onclick="openNav()"><img class="img-menu" src="https://www.plata.ie/images/header-icon-hamburger.svg"></a></td>
        </table>
</table>
...
function showHideTheme() {
   var element = document.getElementById('menu-sandwich');
   element.classList.toggle("dark-mode");

     var img = document.getElementsByClassName("plata-font");
