...
<head>
    ...
    <title>Split</title>
    <link rel="stylesheet" href="desktop-split.css">
    <style>
        .donut-background {
            width: 100%;
            height: 100%;
...
<body>
    ...
    <div class="main-content">
        <h1 class="title">Plata Tokenomics</h1>

        <div class="split-tables">
            <div class="left-column">
                <h1 class="token-title token-title-2024">Token Allocation (2024)</h1>
                ...
                <div class="graph-footer">Circulating Supply: 11,299,000,992 PLT</div>
            </div>
            <div class="right-column">
                <ul class="token-list token-list-2024">
                    ...
                    foreach ($data as $index => $item) {
                        ...
                        echo $item['exchange'];
                        echo ' ( ' . $item['percentage'] * 100 . '% ) ';
                        echo '</li>';
                    }
                    ?>
                </ul>
                <ul class="token-list token-list-2023">
                    <li class="token-item">
                ...
                <ul class="token-list token-list-nft">
                    <li class="token-item">
                        <span class="color-box" style="background-color: #6b4f91;"></span>
                ...
                <ul class="token-list token-list-2022">
                    <li class="token-item">
                        <span class="color-box" style="background-color: #9d487c"></span>
                ...
                <div class="buttons-content">
                    <label for="radio-2024" class="button label-2024">01/2024</label>
