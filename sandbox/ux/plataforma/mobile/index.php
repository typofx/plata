...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/en/mobile/header.php'; ?>
    ...
    <center>
        ...
        <div class="container">
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<br><p>Plata Token (PLT) is listed on ' . $totalListed . ' projects.</p>';
                echo '</form>';
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<img src="' . (empty($row["logo"]) ? "https://plata.ie/images/platatoken200px.png" : "https://www.plata.ie/images/icolog/" . $row["logo"]) . '" alt="img" height="25px" class="black-and-white" style="vertical-align: middle;margin-right: 7px">';
            ...
            echo '>';
            echo '<label for="platalisted"> Where Plata Token is listed.</label>';
            echo '</form>';
            echo '</div>';
            ?>
