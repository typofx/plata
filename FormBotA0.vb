...
Namespace WinFormsApp1
    Partial Public Class FormBotA0
        Inherits Form
        Private webBrowsers As WebBrowser()
        Private urls As String() = {
            "https://typofx.ie/plataforma/panel/lp-contracts/index.php?passwrd=platabotacess20112024@",
            "https://typofx.ie/plataforma/panel/asset/index.php?passwrd=platabotacess20112024@",
            "https://typofx.ie/plataforma/panel/order-book/index.php?passwrd=platabotacess20112024@",
            "https://typofx.ie/plataforma/panel/tokenomics/index.php?passwrd=platabotacess20112024@"
        }
        ...
        Public Sub New()
            ...
            AddHandler Me.FormClosing, AddressOf FormBotA0_FormClosing
            AddHandler Shown, AddressOf FormBotA0_Shown
        End Sub

        Private Sub FormBotA0_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Private Async Sub EnviarSinalOnlineAsync()
            Try
                ...
                Dim app As String = "Database Scripts A" & ScriptNumber
        ...
        Private Async Sub FormBotA0_FormClosing(sender As Object, e As FormClosingEventArgs)
        ...
        Private Sub FormBotA0_Shown(sender As Object, e As EventArgs)
