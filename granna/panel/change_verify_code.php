...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($entered_code == $_SESSION['forgot_verification_code']) {
        echo "<script>window.location.href='change_reset_password.php';</script>";
        exit();
    } else {
...
<center>
    ...
    <form action="change_verify_code.php" method="POST">
        <?php
        ...
        ?>
        <label for="email"><?php echo $_SESSION['code_email'] ?></label><br><br>
    ...
    <?php if ($_SESSION['resends'] < 3): ?>
        <p><a href="change_resend.php">Resend Code (<?php echo $_SESSION['resends']; ?>/3)</a></p>
    <?php else: ?>
