...
if (!isset($_SESSION['forgot_user_email']) || !isset($_SESSION['resends'])) {
    echo "Session expired. Please restart the process.";
    echo "<script>window.location.href='forgot_verify_code.php';</script>";
    exit();
}
...
if ($_SESSION['resends'] < 3) {
    ...
    if (mail($to, $subject, $message, $headers)) {
        ...
        header("Location: forgot_verify_code.php");
        exit();
    } else {
