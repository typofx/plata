...
if (!isset($_SESSION['forgot_user_email']) || !isset($_SESSION['forgot_verification_code'])) {
...
<body>
    ...
    <form action="forgot_reset_password.php" method="POST" onsubmit="return get_action();">
