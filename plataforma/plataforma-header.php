          ...
          <th class="align-text-dropdown">
            <table class="dropdown">
              <td class="menu-bar">
                ...
                <table for="Products">
                    <tr>
                    <th><a class="dropdown-span">X <span><svg xmlns="http://www.w3.org/2000/svg" width="14.2" height="11.5" fill="currentColor" class="bi bi-chevron-down rotate-on-hover" viewBox="0 0 16 16">
                      <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                    </svg></span></th>
                    </tr> 
                </table>
                ...
                <table class="dropdown-content">
                  ...
                  <tr>
                    <th class="th-dropdown"><a class="dropdown-span" href="">X <img width="24" src="https://www.plata.ie/images/icon-new.svg"></a></th>
                  </tr>
                <tr>
            ...
            <table class="dropdown">
              <td class="menu-bar">
                ...
                <table class="dropdown-content">
                  ...
                  <tr>
                    <th class="th-dropdown"><a class="dropdown-span" href="https://www.plata.ie/reg">Token's Info</a></th> 
                  </tr>
                </table>
              </td>
            </table>
