...
<body>
    <h2>Edit Footer Items</h2>
    <form method="POST">
        <?php foreach ($items as $item) : ?>
            <div class="item-container">
                <input type="hidden" name="items[<?php echo $item['id']; ?>][id]" value="<?php echo $item['id']; ?>">

                <label for="column_id_<?php echo $item['id']; ?>">Column:</label>
                <select id="column_id_<?php echo $item['id']; ?>" name="items[<?php echo $item['id']; ?>][column_id]" required>
