...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($column_id) && !empty($item_name) && !empty($item_order)) {
        // Insert into `plata_footer` table
        $query = "INSERT INTO granna80_bdlinks.plata_footer (column_id, item_name, link, item_order) VALUES (?, ?, ?, ?)";
...
// Fetch available columns from `plata_footer_columns`
