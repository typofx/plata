...
if (!$row) {
    $sql = "INSERT INTO granna80_bdlinks.granna_footer_editable_items (folder_path, background_color, terms_conditions_link, slogan, privacy_link, year, icon_background_color)
            VALUES ('', '#ffffff', '', '', '', '', '')";
    if ($conn->query($sql)) {
        $row = [
            'folder_path' => '',
