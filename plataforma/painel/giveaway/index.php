...
<body>
    ...
    $sql = "SELECT id, evm_wallet, vote_image, vote_number, time, txid, MATICPLT FROM granna80_bdlinks.votes";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr>
                    ...
                    <td><img src='https://plata.ie/upvote/" . $row['vote_image'] . "' width='50' height='50' alt='Image'></td>
