...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_icon'])) {
    ...
    $insertQuery = "INSERT INTO granna80_bdlinks.typofx_header_editable_items (name, url, icon_src, order_number, is_hidden) 
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_icon'])) {
    ...
    // Update database
    $updateQuery = "UPDATE granna80_bdlinks.typofx_header_editable_items 
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_icon'])) {
    ...
    $query = "SELECT icon_src FROM granna80_bdlinks.typofx_header_editable_items WHERE id = $iconId";
    ...
    $deleteQuery = "DELETE FROM granna80_bdlinks.typofx_header_editable_items WHERE id = $iconId";
...
// Get all icons
$queryIcons = "SELECT * FROM granna80_bdlinks.typofx_header_editable_items ORDER BY order_number";
