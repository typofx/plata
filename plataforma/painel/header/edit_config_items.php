...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_custom_option'])) {
    ...
    $insertQuery = "INSERT INTO granna80_bdlinks.plata_header_custom_config_options (name, url, is_hidden) 
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_custom_option'])) {
    ...
    $updateQuery = "UPDATE granna80_bdlinks.plata_header_custom_config_options 
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_custom_option'])) {
    $id = intval($_POST['id']);
    $deleteQuery = "DELETE FROM granna80_bdlinks.plata_header_custom_config_options WHERE id = $id";
...
// Get custom options
$queryCustomOptions = "SELECT id, name, url, is_hidden FROM granna80_bdlinks.plata_header_custom_config_options";
