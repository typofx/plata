...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (isset($_FILES['icon']) && $_FILES['icon']['error'] == 0) {
            ...
            $target_dir = $_SERVER['DOCUMENT_ROOT'] . "/images/assets-icons/";
      ...
      WHERE id = ?";
        ...
        if ($stmt = mysqli_prepare($conn, $query)) {
            mysqli_stmt_bind_param($stmt, "sssdssssi", $contract_name, $aka_contract_name, $ticker_symbol, $decimal_value, $price, $name, $pool, $icon_path, $id);
            ...
            <body>
                ...
                <form action="edit.php?id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <?php if (!empty($icon_path)) { ?>
                        <img src="/images/assets-icons/<?php echo $icon_path; ?>" alt="Asset Icon" style="width:100px;height:100px;"><br><br>
                    <?php } else { ?>
                        <p>No icon available.</p><br><br>
                    <?php } ?>
                    <label>Upload new Icon:</label><br>
